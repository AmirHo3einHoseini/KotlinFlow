...
import com.example.kotlinflow.databinding.ActivityBasicFlowBinding
...
class BasicFlowActivity : AppCompatActivity() {
    private lateinit var binding: ActivityBasicFlowBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBasicFlowBinding.inflate(layoutInflater)
    ...
    private fun intiView() {
        binding.apply {
            btnBasicData.setOnClickListener {
...
//                    convertToFLow()
    ...
    private suspend fun simpleFlow() {
        flowOf(1, 2, 4, 5, 7, 9)
            .collect {
                binding.txtShowBasic.append("$it\n")
            }
    }
